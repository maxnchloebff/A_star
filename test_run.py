...
from A_star import find_global_path
...
ACTION_PORT = 20011
ROBOT_ID = 6
robot_list =np.array([1,2,3,5,6,7,8,9,10,11])
ROBOT_ME = 4
...
if __name__ == '__main__':
    ...
    path_finder = find_global_path(vision_module=vision,destination=destination, start = start)
